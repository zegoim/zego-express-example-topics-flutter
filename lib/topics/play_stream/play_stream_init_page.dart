...
class PlayStreamInitPage extends StatefulWidget {
  @override
  _PlayStreamInitPageState createState() => new _PlayStreamInitPageState();
}

class _PlayStreamInitPageState extends State<PlayStreamInitPage> {
